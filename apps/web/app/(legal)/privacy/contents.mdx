...
Your privacy is important to us. It is Ultracite's policy to respect your privacy and comply with any applicable law and regulation regarding any personal information we may collect about you, including across our website, [Ultracite Cloud](https://app.ultracite.ai), and other sites we own and operate.
...
We may ask for personal information - for example when you submit content to us, when you register an account - which may include one or more of the following:
...
The GDPR distinguishes between organizations that process personal information for their own purposes (known as "data controllers") and organizations that process personal information on behalf of other organizations (known as "data processors"). We, Ultracite, located at the address provided in our Contact Us section, are a Data Controller with respect to the personal information you provide to us.
