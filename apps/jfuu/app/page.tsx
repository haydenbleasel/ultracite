  ...
  <main className="mx-auto max-w-2xl px-6 py-20">
    ...
    <section className="mb-16">
      ...
      <ul className="mb-4 list-inside list-disc space-y-2 text-muted-foreground">
        ...
        <li>
          Rules that your AI assistant ignores because it has no idea they exist
        </li>
      </ul>
    ...
    <section className="mb-16">
      ...
      <div className="rounded-lg bg-sidebar p-4 font-mono text-sm">
        <div className="space-y-1">
          ...
          <p className="text-red-400 line-through">eslint-plugin-react-hooks</p>
          <p className="text-red-400 line-through">@typescript-eslint/parser</p>
    ...
    <section className="mb-16">
      ...
      <p className="text-muted-foreground leading-relaxed">
        Done. You now have hundreds of battle-tested linting rules, a formatter
        that doesn't fight your linter, and your AI assistant actually knows
        about your code style.
      </p>
    </section>
      ...
      <div className="space-y-6">
        ...
        <div>
          ...
          <p className="text-muted-foreground leading-relaxed">
            ...
            GitHub Copilot, and more. So when you ask your AI to write code, it
            follows <span className="italic">your</span> rules instead of making
            up its own bullshit.
          </p>
        </div>
        <div>
          ...
          <p className="text-muted-foreground leading-relaxed">
            ...
            accessibility, performance, security—it's all there. You don't need
            to read through 500 rule descriptions to build a good config.
          </p>
        </div>
        <div>
          <h3 className="mb-2 font-medium text-lg text-zinc-200">
        ...
        <div>
          ...
          <p className="text-muted-foreground leading-relaxed">
            ...
            Ultracite has framework-specific presets for all of them. Just pick
            yours and go.
          </p>
        </div>
      </div>
    ...
    <section className="mb-16">
      ...
      <p className="mb-4 text-muted-foreground leading-relaxed">
        ...
        doesn't know they exist. Ultracite generates rule files that your AI can
        actually read.
      </p>
      <div className="mb-4 space-y-3">
    ...
    <section className="mb-16">
      ...
      <p className="mt-4 text-muted-foreground text-sm">
        TL;DR: ESLint if you need specific plugins. Biome if you want speed and
        simplicity. Oxlint if you like living on the edge.
      </p>
    </section>
    ...
    <section className="mb-16">
      ...
      <div className="space-y-6">
        <div>
          ...
          <p className="text-muted-foreground leading-relaxed">
            Cool. Override them. Ultracite is just a preset—you can add whatever
            rules you want on top. But you probably don't need to. The defaults
            are good.
          </p>
        </div>
        <div>
        ...
        <div>
          ...
          <p className="text-muted-foreground leading-relaxed">
            Your team will like shipping code faster. Stop having meetings about
            formatting. Accept the defaults and move on with your lives.
          </p>
        </div>
      </div>
    </section>
    ...
    {/* Decision Flowchart */}
    <section className="mb-16">
      <h2 className="mb-4 font-semibold text-2xl">Should you use Ultracite?</h2>
      <div className="rounded-lg bg-sidebar p-6 font-mono text-sm">
        <div className="space-y-4">
          ...
          <div className="ml-4 space-y-2">
            <p className="text-muted-foreground">
              ├─ <span className="text-green-400">Yes</span> → You're lying. Use
              Ultracite.
            </p>
            <p className="text-muted-foreground">
    ...
    <section className="mb-16">
      ...
      <p className="mb-6 text-muted-foreground leading-relaxed">
        You've been thinking about fixing your linting setup for months. Here's
        your sign. Run this and pick your preferred toolchain:
      </p>
      ...
      <p className="mb-6 text-muted-foreground leading-relaxed">
        That's literally it. ESLint, Biome, Oxlint—whatever you pick, you'll get
        a bulletproof config in seconds. Stop overthinking. Stop researching.
        Stop comparing. Just fucking use Ultracite.
      </p>
      <a
