...
export default defineConfig({
  extends: ["./node_modules/ultracite/config/oxlint/core/index.ts"],
});
```
...
export default defineConfig({
  extends: [
    "./node_modules/ultracite/config/oxlint/core/index.ts",
    "./node_modules/ultracite/config/oxlint/react/index.ts",
    "./node_modules/ultracite/config/oxlint/next/index.ts",
  ],
});
```

You can also use Ultracite's typed exports for a more ergonomic API:
