...
export const Hero = ({ children }: HeroProps) => (
  <div className="grid gap-8 pt-8 sm:gap-20 sm:pt-20">
    <div className="grid gap-4">
      <h1 className="mb-0 max-w-md text-balance font-medium text-3xl leading-none sm:text-4xl md:text-5xl lg:text-6xl">
      ...
      <div className="flex w-full max-w-md flex-col items-center gap-4 sm:flex-row">
        ...
        <Button asChild className="px-4" size="lg" variant="link">
          <DynamicLink href="/introduction">Read the docs</DynamicLink>
        </Button>
      </div>
    </div>
    {children}
