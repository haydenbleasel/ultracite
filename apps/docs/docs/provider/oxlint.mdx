...
This is **off by default** because it adds dependencies and runs a slower JavaScript lint pass instead of the native Rust one. Opt in only if you want the extra rules and accept the trade-off.
