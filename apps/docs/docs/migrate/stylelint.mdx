...
If you prefer more control over the process, follow the [Manual Setup](/docs/setup#manual-setup) steps and manually remove Stylelint and its configuration files.
