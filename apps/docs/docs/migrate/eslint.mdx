...
The fastest way is to run the [automatic setup script](/docs/setup#automatic-installation).
...
If you prefer more control over the process, follow the [Manual Setup](/docs/setup#manual-setup) steps and manually remove ESLint and its configuration files.
