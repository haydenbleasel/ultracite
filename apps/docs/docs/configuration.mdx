...
The pattern is the same across all supported linters — import the `core` preset, then add any framework presets you need. For example, if you're using Biome with React and Next.js, you can pull in the following presets:
