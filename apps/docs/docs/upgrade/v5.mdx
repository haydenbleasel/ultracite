---
title: Upgrade to v5
description: Upgrade from Ultracite v4 to v5 with the changes needed for new presets, generated configs, and any breaking linting behavior.
---
...
If you prefer more control over the process, follow the [Manual Migration](/docs/setup#manual-installation) steps by:
