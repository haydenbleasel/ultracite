...
- **[Biome](/docs/provider/biome)** — The modern, all-in-one toolchain (default)
- **[ESLint + Prettier + Stylelint](/docs/provider/eslint)** — The most mature ecosystem
- **[Oxlint + Oxfmt](/docs/provider/oxlint)** — The fastest option
