...
If you prefer to stay in the ESLint ecosystem — for example, because you rely on a specialized ESLint plugin — you can choose Ultracite’s [ESLint + Prettier + Stylelint provider](/provider/eslint) instead, which gives you the same curated preset on top of those tools.
