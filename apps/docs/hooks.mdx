...
Some tools like Cursor, Windsurf, and Claude Code support hooks that run after AI agents edit files. Ultracite can configure these hooks automatically.
...
```bash
npx ultracite init --hooks cursor windsurf claude
```
