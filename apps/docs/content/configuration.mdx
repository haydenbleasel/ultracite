...
The default configuration for Ultracite is designed for Next.js projects. It includes all the rules relevant to [React](/preset/react) and [Next.js](/preset/next). You can use it by extending the `ultracite` preset:
...
- **[`ultracite/core`](/preset/core)** - Base configuration for JavaScript / TypeScript projects
...
- **[`ultracite/svelte`](/preset/svelte)** - Svelte-specific rules
...
For a comprehensive reference of all linting rules configured in Ultracite's base configuration, see the [Core Configuration](/core) documentation.
