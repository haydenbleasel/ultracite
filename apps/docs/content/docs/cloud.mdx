...
| --- | --- | --- |
| Input tokens | $1 / MTok | Claude 4.5 Haiku, [at-cost pricing](https://platform.claude.com/docs/en/about-claude/pricing) |
| Output tokens | $5 / MTok | Claude 4.5 Haiku, [at-cost pricing](https://platform.claude.com/docs/en/about-claude/pricing) |
| Workflow runs | $0.025 / run | Vercel Sandbox, [estimated at-cost pricing](https://vercel.com/docs/vercel-sandbox/pricing) (see below) |

### Example

A typical PR review might use:
- ~10,000 input tokens ($0.01)
- ~5,000 output tokens ($0.025)
- 1 workflow run ($0.025)

**Total: ~$0.06 per PR review**
