---
title: Hooks
description: How to integrate Ultracite with AI coding assistants through editor hooks.
---
...
Some editors like Cursor and Windsurf support hooks that run after AI agents edit files. Ultracite can configure these hooks automatically.
...
```bash
npx ultracite init --hooks cursor,windsurf
```
