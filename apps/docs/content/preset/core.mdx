...
Nursery rules are generally not enabled in Ultracite as they are experimental and may change or be removed in future Biome versions. However, the following rule is enabled due to popular demand:
