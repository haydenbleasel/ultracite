...
The core Ultracite configuration (`ultracite`) provides a comprehensive set of framework-agnostic linting rules and formatting settings. This is the foundation that all other framework-specific configurations extend.
...
The core configuration includes 273+ strict linting rules covering:
...
To override any rules, modify your `biome.jsonc`:
...
- [React Configuration](/react) - Add React-specific rules
- [Next.js Configuration](/next) - Add Next.js-specific rules
- [Configuration Guide](/configuration) - Learn more about customization
