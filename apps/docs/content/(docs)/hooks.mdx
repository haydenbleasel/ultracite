...
When you select **Cursor** during the initialization process, Ultracite automatically configures a hook to run after every file edit made by the Cursor agent.
...
If you skipped the Cursor integration during initialization, you can manually add the hook:
