...
| `--frameworks`      | The frameworks to configure.                     | Comma-separated: `react`, `next`, `solid`, `vue`, `svelte`, `qwik`, `remix`, `angular`, `astro` |
| `--editors`         | The editors to configure.                        | Comma-separated: `vscode`, `cursor`, `windsurf`, `antigravity`, `kiro`, `trae`, `void`, `zed` |
| `--agents`          | The AI agents to configure.                      | Comma-separated: `claude`, `codex`, `jules`, `copilot`, `cline`, `amp`, `aider`, `firebase-studio`, `open-hands`, `gemini`, `junie`, `augmentcode`, `kilo-code`, `goose`, `roo-code`, `warp`, `droid`, `opencode`, `crush`, `qwen`, `amazon-q-cli`, `firebender`, `cursor-cli`, `mistral-vibe`, `vercel` |
| `--hooks`           | The agent hooks to configure.                    | Comma-separated: `cursor`, `windsurf`, `claude`                         |
| `--integrations`    | Additional integrations to setup.                | Comma-separated: `husky`, `lefthook`, `lint-staged`, `pre-commit`       |
