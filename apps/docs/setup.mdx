...
| `--agents`       | The AI agents to configure.                                                                             | Space-separated: `claude`, `codex`, `jules`, `replit`, `devin`, `lovable`, `zencoder`, `ona`, `openclaw`, `continue`, `snowflake-cortex`, `deepagents`, `qoder`, `kimi-cli`, `mcpjam`, `mux`, `pi`, `adal`, `copilot`, `cline`, `amp`, `aider`, `firebase-studio`, `open-hands`, `gemini`, `junie`, `augmentcode`, `kilo-code`, `goose`, `roo-code`, `warp`, `droid`, `opencode`, `crush`, `qwen`, `amazon-q-cli`, `firebender`, `cursor-cli`, `mistral-vibe`, `vercel` |
