  ...
  describe('remove', () => {
    ...
    test('removes language-specific prettier formatters', async () => {
      ...
      mock.module('node:fs/promises', () => ({
        ...
        readFile: mock((path: string) => {
          if (path === './.vscode/settings.json') {
            return Promise.resolve('{"[javascript]": {"editor.defaultFormatter": "esbenp.prettier-vscode"}}');
          }
          return Promise.resolve('{}');
        }),
      ...
      mock.module('node:fs/promises', () => ({
        ...
        readFile: mock((path: string) => {
          if (path === './.vscode/settings.json') {
            ...
            return Promise.resolve('{"[javascript]": {"editor.defaultFormatter": "esbenp.prettier-vscode"}, "editor.tabSize": 2}');
          }
          return Promise.resolve('{}');
        }),
        writeFile: mockWriteFile,
