export const core = [
  ...
  "Don't use unknown CSS value functions.",
  "Don't use unknown media feature names.",
  "Don't use unknown properties.",
  "Don't use unknown pseudo-class selectors.",
  "Don't use unknown pseudo-element selectors.",
  "Don't use unknown type selectors.",
  "Don't use unknown CSS units.",
  "Don't use unmatchable An+B selectors.",
  ...
  "Don't use `@value` rule in CSS modules.",
  ...
  "Don't use `!important` within keyframe declarations.",
