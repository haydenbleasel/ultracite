export const core = [
  ...
  "No lexical decls in switch clauses",
  "No undeclared vars",
  ...
  "No expr stmts that aren't fn calls or assignments",
  ...
  "Make switch-case stmts exhaustive",
  ...
  "Use `else if` vs nested `if` in `else` clauses",
  "Use single `if` vs nested `if` clauses",
  ...
  "No duplicate custom props within decl blocks",
  ...
  "No two keys w/ same name in objects",
  "No duplicate fn param names",
  "No duplicate props within decl blocks",
  "No duplicate selectors within keyframe blocks",
  "No duplicate hooks in describe blocks",
  "No empty CSS blocks",
  "No empty block stmts and static blocks",
  "No empty interfaces",
  ...
  "Use `Number.isFinite` vs global `isFinite`",
  "Use `Number.isNaN` vs global `isNaN`",
