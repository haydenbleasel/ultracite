export const core = [
  ...
  "Avoid the `accessKey` attribute.",
  'Don\'t set `aria-hidden="true"` on focusable elements.',
  "Avoid ARIA roles, states, and properties on elements that don't support them.",
  "Avoid distracting elements.",
  "Use the `scope` prop only on `<th>` elements.",
  "Don't assign non-interactive ARIA roles to interactive HTML elements.",
  "Ensure label elements have text and an associated input.",
  "Avoid event handlers on non-interactive elements.",
  "Don't assign interactive ARIA roles to non-interactive HTML elements.",
  "Don't assign `tabIndex` to non-interactive HTML elements.",
  "Avoid positive integers on the `tabIndex` property.",
  "Avoid the words `image`, `picture`, or `photo` in img alt props.",
  ...
  "Include a generic font family in font families.",

  // Complexity

  "Avoid consecutive spaces in regex literals.",
  "Avoid `arguments`.",
  "Avoid primitive type aliases or misleading types.",
  "Avoid the comma operator.",
  "Avoid empty type parameters in type aliases and interfaces.",
  ...
  "Avoid unnecessary callbacks on `flatMap`.",
  "Use `for...of` instead of `Array.forEach`.",
  "Don't create classes with no non-static members.",
  "Avoid `this` and `super` in static contexts.",
  "Avoid unnecessary catch clauses.",
  "Avoid unnecessary constructors.",
  "Avoid unnecessary `continue`.",
  "Avoid empty exports.",
  "Avoid unnecessary escape sequences in regex literals.",
  ...
  "Avoid `String.raw` without escape sequences.",
  "Avoid useless cases in switch statements.",
  "Use simpler alternatives to ternary operators when possible.",
  "Avoid useless `this` aliasing.",
  "Avoid `any` or `unknown` as type constraints.",
  ...
  "Avoid constant expressions in conditions.",
  "Avoid `Math.min`/`Math.max` to clamp values where the result is constant.",
  "Don't return values from constructors.",
  "Avoid empty character classes in regex literals.",
  "Avoid empty destructuring patterns.",
  "Avoid `__dirname` and `__filename` in the global scope.",
  ...
  "Avoid variables and parameters before their declaration.",
  "Include `var` function for CSS variables.",
  "Avoid `\\8` and `\\9` escape sequences in strings.",
  "Avoid literal numbers that lose precision.",
  "Avoid configured elements.",
  ...
  "Avoid lexical declarations in switch clauses.",
  "Avoid undeclared variables.",
  "Avoid unknown CSS value functions.",
  "Avoid unknown media feature names.",
  "Avoid unknown properties.",
  "Avoid unknown pseudo-class selectors.",
  "Avoid unknown pseudo-element selectors.",
  "Avoid unknown type selectors.",
  "Avoid unknown CSS units.",
  "Avoid unmatchable An+B selectors.",
  "Don't write unreachable code.",
  "Call `super()` exactly once before accessing `this` in constructors.",
  "Avoid control flow statements in `finally` blocks.",
  "Avoid optional chaining where `undefined` is not allowed.",
  ...
  "Avoid Promises where they're likely a mistake.",
  "Avoid non-null assertions after optional chaining.",
  "Don't shadow variables from the outer scope.",
  "Avoid expression statements that aren't function calls or assignments.",
  "Avoid useless `undefined`.",
  ...
  "Avoid dangerous JSX props.",
  "Avoid both `children` and `dangerouslySetInnerHTML` props.",
  "Avoid global `eval()`.",

  // Style

  "Avoid callbacks in asynchronous tests and hooks.",
  "Avoid TS enums.",
  "Don't export imported variables.",
  "Avoid type annotations for variables initialized with literals.",
  ...
  "Avoid specified global variable names.",
  "Don't import specified modules.",
  "Avoid specified user-defined types.",
  "Avoid constants where the value is the upper-case version of the name.",
  "Use `String.slice()` instead of `String.substr()` and `String.substring()`.",
  "Avoid template literals without interpolation or special characters.",
  "Avoid `else` blocks when the `if` block breaks early.",
  ...
  "Avoid overload signatures that can be unified.",
  "Don't place lower specificity selectors after higher specificity selectors.",
  "Avoid `@value` rule in CSS modules.",
  ...
  "Avoid the `!` pattern in the first position of `files.includes`.",
  "Avoid bitwise operators.",
  "Don't reassign exceptions in catch clauses.",
  "Don't reassign class members.",
  "Don't insert comments as text nodes.",
  "Don't compare against `-0`.",
  "Avoid labeled statements that aren't loops.",
  "Avoid `void` type outside of generic or return types.",
  "Avoid `console`.",
  "Avoid TS const enums.",
  "Avoid expressions where the operation doesn't affect the value.",
  "Avoid control characters in regex literals.",
  "Avoid `debugger`.",
  "Don't assign directly to `document.cookie`.",
  "Use `===` and `!==`.",
  "Don't duplicate `@import` rules.",
  "Don't duplicate case labels.",
  "Don't duplicate class members.",
  "Don't duplicate custom properties within declaration blocks.",
  "Don't duplicate conditions in if-else-if chains.",
  "Don't duplicate fields in GraphQL operations.",
  "Don't duplicate names within font families.",
  "Avoid two keys with the same name in objects.",
  "Don't duplicate function parameter names.",
  "Don't duplicate properties within declaration blocks.",
  "Don't duplicate selectors within keyframe blocks.",
  "Don't duplicate hooks in describe blocks.",
  "Avoid empty CSS blocks.",
  "Avoid empty block statements and static blocks.",
  "Don't declare empty interfaces.",
  "Don't let variables evolve into `any` type through reassignments.",
  "Avoid the `any` type.",
  "Avoid `export` or `module.exports` in test files.",
  ...
  "Avoid implicit `any` type on variable declarations.",
  "Don't assign to imported bindings.",
  "Avoid `!important` within keyframe declarations.",
  "Avoid irregular whitespace characters.",
  "Avoid labels that share a name with a variable.",
  "Avoid characters made with multiple code points in character classes.",
  "Use `new` and `constructor` properly.",
  "Place assertion functions inside `it()` function calls.",
  "Avoid shorthand assign when the variable appears on both sides.",
  "Avoid octal escape sequences in strings.",
  "Avoid `Object.prototype` builtins directly.",
  "Avoid `quickfix.biome` in editor settings.",
  "Don't redeclare variables, functions, classes, and types in the same scope.",
  "Avoid redundant `use strict`.",
  ...
  "Avoid disabled tests.",
  "Avoid sparse arrays.",
  "Avoid template literal placeholder syntax in regular strings.",
  "Avoid `then` property.",
  "Avoid the `@ts-ignore` directive.",
  "Avoid `let` or `var` variables that are read but never assigned.",
  "Avoid unknown at-rules.",
  "Don't merge interface and class declarations unsafely.",
  "Avoid unsafe negation (`!`).",
  "Avoid unnecessary escapes in strings.",
  "Avoid useless backreferences in regex literals.",
  "Avoid `var`.",
...
export const react = [
  ...
  "Avoid the return value from `ReactDOM.render()`.",
  ...
  "Avoid legacy `React.forwardRef`. Use ref as a prop instead (React 19+).",
  ...
  "Avoid semicolons that change JSX element semantics.",
];
...
export const qwik = [
  ...
  "Avoid `useVisibleTask$`. Use `useTask$` or `useResource$` instead.",
  ...
  "Avoid React-specific props like `className` and `htmlFor`. Use `class` and `for` instead.",
];
...
export const vue = [
  ...
  "Avoid object declarations for the `data` option. Use a function that returns an object.",
  "Don't duplicate keys in Vue component options.",
  "Avoid Vue reserved keys like `$data`, `$props`, and `$el` in component options.",
  "Avoid Vue reserved props like `key`, `ref`, and `is` as custom component props.",
