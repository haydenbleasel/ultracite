...
Yes — we focused on VS Code and its forks as they're the most popular IDEs for modern web development, but Biome can be used purely via CLI or with other IDEs. Check out Biome's [first-party editor integrations](https://biomejs.dev/guides/editors/first-party-extensions/) and [third-party editor integrations](https://biomejs.dev/guides/editors/third-party-extensions/) for more information.
