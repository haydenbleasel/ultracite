...
Ultracite provides seamless integration with [lefthook](https://github.com/evilmartians/lefthook), a fast and powerful Git hooks manager. This integration automatically sets up pre-commit hooks to ensure your code is properly formatted before every commit.
