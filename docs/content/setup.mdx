...
Ultracite is designed to work best with the VS Code / Cursor on-save functionality. Create or update your workspace `.vscode/settings.json` with the following configuration:
